...
<script>
    ...
    // For each owl item
    $('.dt-owl-item').each(function() {
        // Get the href from the image link
        var href = $(this).find('.dt-owl-item-image').attr('href');
        
        // Remove the href from image and heading
        $(this).find('.dt-owl-item-image, .dt-owl-item-heading a').removeAttr('href');
        ...
        // Prevent default behavior for any remaining links inside
